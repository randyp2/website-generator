      ...
      <div className="relative max-w-6xl mx-auto px-6 py-12">
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
          <div className="space-y-2">
            <div className="text-2xl font-bold">PortfolioAI</div>
            <p className="text-sm text-white/70 max-w-md">
              AI-crafted portfolios, deployed in minutes. Customize, preview, and launch without touching code.
            </p>
          </div>
        ...
        <div className="mt-10 border-t border-white/5 pt-6 flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
          <span className="text-xs text-white/50">© 2025 PortfolioAI. All rights reserved.</span>
          <span className="text-xs text-white/50">Built for creators, designers, and developers.</span>
        </div>
      </div>
    </footer>
  );
