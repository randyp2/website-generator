...
export const LandingPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen pt-20">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <motion.button
                ...
                className="group px-8 py-4 bg-gradient-to-r from-sky-500 to-cyan-500 text-white rounded-xl font-bold shadow-xl shadow-sky-400/30 hover:shadow-2xl hover:shadow-sky-500/40 transition-all flex items-center gap-2"
              >
          ...
          >
            <div className="relative max-w-5xl mx-auto">
              {/* Glow effect */}
              <div className="absolute inset-0 bg-gradient-to-r from-sky-400/20 via-cyan-400/20 to-teal-400/20 rounded-3xl blur-3xl" />
              ...
              <div className="relative bg-white/80 backdrop-blur-xl border-2 border-white/40 rounded-3xl shadow-2xl overflow-hidden">
                ...
                <div className="relative bg-gradient-to-br from-slate-50 via-white to-sky-50/30 p-8 min-h-[500px]">
                  ...
                  <div className="space-y-8">
                    ...
                    >
                      ...
                      <motion.div
                        ...
                        className="w-24 h-24 rounded-full bg-gradient-to-br from-sky-400 to-cyan-500 mx-auto mb-6 flex items-center justify-center shadow-xl shadow-sky-400/30"
                      >
                      ...
                      <div className="mb-3">
                        <motion.div
                          ...
                          className="h-8 bg-gradient-to-r from-slate-200 via-slate-300 to-slate-200 rounded-lg mx-auto relative overflow-hidden"
                        >
                          <motion.div
                            animate={{ x: ["-100%", "200%"] }}
                      ...
                      <div className="mb-6">
                        <motion.div
                          ...
                          className="h-4 bg-gradient-to-r from-slate-100 via-slate-200 to-slate-100 rounded-lg mx-auto relative overflow-hidden"
                        >
                          <motion.div
                            animate={{ x: ["-100%", "200%"] }}
                    ...
                    >
                      <div className="text-center mb-6">
                        <div className="h-6 w-32 bg-gradient-to-r from-slate-200 to-slate-300 rounded-lg mx-auto mb-4" />
                      </div>
                      <div className="flex flex-wrap justify-center gap-3">
                        {["React", "TypeScript", "Node.js", "Python", "Tailwind", "AWS"].map((skill, i) => (
                          <motion.div
                            ...
                            whileHover={{ scale: 1.1, y: -2 }}
                            className="px-4 py-2 bg-gradient-to-r from-sky-100 to-cyan-100 border border-sky-200 rounded-lg text-sm font-medium text-slate-700"
                          >
                            {skill}
                          </motion.div>
                        ))}
                  ...
                  <motion.div
                    ...
                    className="absolute top-10 right-10 w-12 h-12 bg-gradient-to-br from-sky-400 to-cyan-500 rounded-lg shadow-lg opacity-20"
                  />
                  <motion.div
                    animate={{
                      y: [0, 10, 0],
                    ...
                    className="absolute bottom-20 left-10 w-16 h-16 bg-gradient-to-br from-teal-400 to-emerald-500 rounded-full shadow-lg opacity-20"
                  />
                </div>
                ...
                <motion.div
                  ...
                  className="bg-gradient-to-r from-sky-50 to-cyan-50 px-6 py-4 border-t border-slate-200 grid grid-cols-3 gap-4"
                >
              ...
              <div className="absolute -top-4 -right-4 w-20 h-20 bg-gradient-to-br from-sky-400 to-cyan-500 rounded-2xl opacity-20 blur-xl" />
              <div className="absolute -bottom-4 -left-4 w-24 h-24 bg-gradient-to-br from-teal-400 to-emerald-500 rounded-2xl opacity-20 blur-xl" />
            </div>
          </motion.div>
            ...
            <div className="flex items-center justify-center gap-3">
              <div className="flex -space-x-2">
                {[1, 2, 3, 4, 5].map((i) => (
                  <div
                    key={i}
                    className="w-10 h-10 rounded-full bg-gradient-to-br from-sky-200 to-cyan-300 border-2 border-white flex items-center justify-center text-xs font-bold text-sky-700"
                  >
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              ...
              >
                <div className="w-14 h-14 bg-gradient-to-br from-cyan-50 to-teal-50 rounded-xl flex items-center justify-center text-cyan-600 mb-5 group-hover:scale-110 transition-transform">
                  {feature.icon}
                </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {examples.map((example, index) => (
              ...
              >
                <div
                  className={`h-48 bg-gradient-to-br ${example.gradient} flex items-center justify-center relative`}
                >
      ...
      {/* About Section */}
      <section className="py-20 px-6 bg-gradient-to-br from-slate-50 to-cyan-50/30">
      ...
      <section className="py-20 px-6">
        ...
        >
          <div className="relative overflow-hidden bg-gradient-to-r from-cyan-500 to-teal-600 rounded-3xl p-12 shadow-2xl">
