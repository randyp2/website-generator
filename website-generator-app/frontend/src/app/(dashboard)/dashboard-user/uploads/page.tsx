...
interface UploadZoneProps {
  ...
  onDelete: (id: string, type: "resume" | "media") => void;
}
  ...
  >
    ...
    >
      ...
      <div className="text-center">
        <motion.div
          animate={dragOver === type ? { scale: 1.1, y: -5 } : { scale: 1, y: 0 }}
      ...
      <AnimatePresence>
        {uploading === type && (
          ...
          >
            ...
            />
            <p className="text-sm font-semibold text-slate-900 mb-2">Uploading...</p>
...
const UploadsPage: React.FC = () => {
  ...
  const handleDragOver = (e: React.DragEvent, type: "resume" | "media") => {
    e.preventDefault();
    setDragOver(type);
  };
          ...
          >
            ...
            >
              ...
              {previewFile.type === "media" ? (
                // eslint-disable-next-line @next/next/no-img-element -- Uses local object URLs for uploaded media previews.
                <img
                  src={previewFile.url}
