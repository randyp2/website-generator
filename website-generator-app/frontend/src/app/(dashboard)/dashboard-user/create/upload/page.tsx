...
const UploadPage: React.FC = () => {
    ...
    /**
     * STATE: Resume file uploaded by the user
     *
     * Stores a single resume file (PDF, DOC, etc.) that the user uploads.
     * This file contains the user's professional information and will be used
     * to generate content for their portfolio website.
     *
     * - Type: UploadedFile | null
     * - Initial value: null (no resume uploaded)
     * - Set to null when user removes the resume
     */
    const [resumeFile, setResumeFile] = useState<UploadedFile | null>(null);

    /**
     * STATE: Confirmed media files with metadata
     *
     * Stores all media files (JPG, PNG images) that have been confirmed by the user
     * after they've added titles and descriptions. These are the "finalized" files
     * that will be included in the portfolio.
     *
     * - Type: UploadedFile[] (array of file objects)
     * - Initial value: [] (empty array)
     * - Each file includes: name, size, type, title, and description
     */
    const [mediaFiles, setMediaFiles] = useState<UploadedFile[]>([]);

    /**
     * STATE: Confirmed video files with metadata
     *
     * Stores all video files (MP3, MP4, MOV) that have been confirmed by the user
     * after they've added titles and descriptions. These are the "finalized" files
     * that will be included in the portfolio.
     *
     * - Type: UploadedFile[] (array of file objects)
