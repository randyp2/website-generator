                        ...
                        <div className="space-y-3">
                            <div className="flex justify-end">
                                <motion.button
                                    ...
                                    className="flex items-center gap-1 text-xs font-semibold text-red-500 hover:text-red-600 dark:text-red-300 dark:hover:text-red-200"
                                >
                    ...
                    <div className="mt-4">
                        ...
                        <ul className="space-y-2 text-foreground/80">
                            {(exp.bullets ?? []).map((bullet, bulletIndex) => (
                                ...
                                >
                                    <span className="mt-2 h-2 w-2 shrink-0 rounded-full bg-foreground/60" />
                                    {isEditing ? (
                                        <div className="flex-1 flex items-start gap-2">
                                            <input
                                                ...
                                                className="flex-1 rounded-2xl border border-border dark:border-white/10 bg-muted/50 dark:bg-white/[0.04] px-4 py-3 text-foreground/90 focus:border-primary/50 focus:outline-none"
                                            />
                                            <motion.button
