...
- Do NOT include a nav item for the hero/intro section: the
  brand/logo element MUST scroll to the top of the page when
  clicked, so navItems link only to content sections below the hero
