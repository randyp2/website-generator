...
- The Navbar MUST NOT include a nav item for the hero/intro section.
  The brand/logo element covers it: clicking the logo MUST scroll to
  the top of the page. navItems link only to content sections below
  the hero.
